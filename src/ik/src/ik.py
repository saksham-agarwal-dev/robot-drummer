...
def ik_service_client():
    ...
    pose_stamped.pose.position.x = float(input("Give x for the gripper: "))
    pose_stamped.pose.position.y = float(input("Give y for the gripper: "))
    pose_stamped.pose.position.z = float(input("Give z for the gripper: "))
